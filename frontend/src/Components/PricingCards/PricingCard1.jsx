...
const features = [
  ...
  { text: 'Access to ReactAC in up to 2 servers', enabled: true },
  { text: '24/7 Support', enabled: true },
  { text: 'Priority Support', enabled: false },
  { text: '99.95% SLA', enabled: false },
  { text: 'Free Installation & Setup*', enabled: false },
  { text: 'Separate Hoisted Discord Role', enabled: false },
  { text: 'Large Discounts on Additional Servers', enabled: false },
];
...
const PricingCard1 = () => {
  return (
    ...
    >
      ...
      <Box sx={{ mt: 2, mb: 2 }}>
        <Button
          component={Link} to="https://buy.stripe.com/test_aFa7sN9lDglU48Ocso8Ra01"
          variant="outlined"
          fullWidth
          sx={{
            borderRadius: '20px',
